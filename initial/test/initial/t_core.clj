...
(facts "about political extreemist plus"
  (fact "it multiplies instead of adds."
       ...
       (political-extreemist-plus 10 2) => 20
       (political-extreemist-plus 10 2 4) => 80))
